...
!function (e, t) {
  ...
  _.fn = _.prototype = {
    ...
    _.extend = _.fn.extend = function () {
      ...
      }, a++), 'object' == typeof s || g(s) || (s = {
      }), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) i = e[t],
      '__proto__' !== t && s !== i && (c && i && (_.isPlainObject(i) || (o = Array.isArray(i))) ? (n = s[t], r = o && !Array.isArray(n) ? [
      ] : o || _.isPlainObject(n) ? n : {
      }, o = !1, s[t] = _.extend(c, r, i))  : void 0 !== i && (s[t] = i));
      return s
    },
    _.extend({
      ...
      makeArray: function (e, t) {
        ...
        return null != e && (S(Object(e)) ? _.merge(n, 'string' == typeof e ? [
          e
        ] : e)  : a.call(n, e)),
          n
      },
      ...
      grep: function (e, t, n) {
        for (var i = [
        ], o = 0, r = e.length, s = !n; o < r; o++) !t(e[o], o) !== s && i.push(e[o]);
        return i
      },
      map: function (e, t, n) {
        var i,
  ...
  var x = function (e) {
    ...
    try {
      N.apply(D = I.call(_.childNodes), _.childNodes),
    ...
    function ae(e, t, i, o) {
      ...
      if (!o && ((t ? t.ownerDocument || t : _) !== f && h(t), t = t || f, g)) {
        if (11 !== C && (d = J.exec(e))) if (r = d[1]) {
          ...
          if (d[2]) return N.apply(i, t.getElementsByTagName(e)),
            i;
          if ((r = d[3]) && n.getElementsByClassName && t.getElementsByClassName) return N.apply(i, t.getElementsByClassName(r)),
            i
        }
    ...
    for (t in n = ae.support = {
      ...
      return s !== f && 9 === s.nodeType && s.documentElement && (p = (f = s).documentElement, g = !r(f), _ !== f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener('unload', re, !1)  : o.attachEvent && o.attachEvent('onunload', re)), n.attributes = ue(function (e) {
        ...
        e.querySelectorAll('[selected]').length || m.push('\\[' + j + '*(?:value|' + M + ')'),
            ...
            : function (t, n, l) {
              ...
              if (m) {
                ...
                if (p = [
                  ...
                  for (b = (f = (c = (u = (d = (h = m) [w] || (h[w] = {
                  })) [h.uniqueID] || (d[h.uniqueID] = {
                  })) [e] || [
                  ]) [0] === C && c[1]) && c[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (b = f = 0) || p.pop(); ) if (1 === h.nodeType && ++b && h === t) {
                    u[e] = [
                      C,
                      f,
                      b
                ...
                ]) [0] === C && c[1]), !1 === b) for (; (h = ++f && h && h[g] || (b = f = 0) || p.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && ((u = (d = h[w] || (h[w] = {
                })) [h.uniqueID] || (d[h.uniqueID] = {
                })) [e] = [
                  C,
                  b
    ...
    function we(e, t, n) {
      ...
      return t.first ? function (t, n, o) {
        ...
        : function (t, n, l) {
          ...
          } else for (; t = t[i]; ) if (1 === t.nodeType || s) if (u = (d = t[w] || (t[w] = {
    ...
    function Ce(e, t, n, i, o) {
      for (var r, s = [
      ], a = 0, l = e.length, c = null != t; a < l; a++) (r = e[a]) && (n && !n(r, i, o) || (s.push(r), c && t.push(a)));
      return s
    }
    function Se(e, t, n, i, o, r) {
      ...
      o && !o[w] && (o = Se(o, r)),
        ce(function (r, s, a, l) {
          ...
          if (n && n(m, v, a, l), i) for (c = Ce(v, f), i(c, [
          ], a, l), u = c.length; u--; ) (d = c[u]) && (v[f[u]] = !(m[f[u]] = d));
          if (r) {
            if (o || e) {
              if (o) {
                for (c = [
          ...
          } else v = Ce(v === s ? v.splice(p, v.length)  : v),
    ...
    function xe(e) {
      ...
      ]; l < r; l++) if (n = i.relative[e[l].type]) h = [
        we(_e(h), n)
      ];
      else {
    ...
    return ye.prototype = i.filters = i.pseudos,
      ...
      s = ae.tokenize = function (e, t) {
        ...
        for (a = e, l = [
          ...
          ])), n = !1, (o = V.exec(a)) && (n = o.shift(), r.push({
            value: n,
            type: o[0].replace(F, ' ')
        ...
        if (!m) {
          ...
          (m = E(e, (o = p, a = 0 < (r = d).length, l = 0 < o.length, u = function (e, t, n, s, u) {
            ...
            if (v += y, a && y !== v) {
              ...
              N.apply(s, w),
              u && !e && 0 < w.length && 1 < v + r.length && ae.uniqueSort(s)
            }
            return u && (C = x, c = _),
              b
          }, a ? ce(u)  : u))).selector = e
      ...
      l = ae.select = function (e, t, n, o) {
        ...
        if (n = n || [
          ...
          if (2 < (l = f[0] = f[0].slice(0)).length && 'ID' === (c = l[0]).type && 9 === t.nodeType && g && i.relative[l[1].type]) {
            if (!(t = (i.find.ID(c.matches[0].replace(te, ne), t) || [
            ]) [0])) return n;
            h && (t = t.parentNode),
              e = e.slice(l.shift().value.length)
          }
          for (r = z.needsContext.test(e) ? 0 : l.length; r-- && (c = l[r], !i.relative[u = c.type]); ) if ((d = i.find[u]) && (o = d(c.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
            if (l.splice(r, 1), !(e = o.length && be(l))) return N.apply(n, o),
              n;
            break
          }
        }
        return (h || a(e, f)) (o, t, !g, n, !t || ee.test(e) && ve(t.parentNode) || t),
          n
      },
  ...
  _.filter = function (e, t, n) {
    ...
    _.fn.extend({
      ...
      is: function (e) {
        return !!D(this, 'string' == typeof e && k.test(e) ? _(e)  : e || [
        ], !1).length
      }
    });
  var P,
  ...
  (_.fn.init = function (e, t, n) {
    ...
    if (n = n || P, 'string' == typeof e) {
      if (!(o = '<' === e[0] && '>' === e[e.length - 1] && 3 <= e.length ? [
        null,
        e,
        null
      ] : L.exec(e)) || !o[1] && t) return !t || t.jquery ? (t || n).find(e)  : this.constructor(t).find(e);
      if (o[1]) {
        if (t = t instanceof _ ? t[0] : t, _.merge(this, _.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), A.test(o[1]) && _.isPlainObject(t)) for (o in t) g(this[o]) ? this[o](t[o])  : this.attr(o, t[o]);
        return this
      }
  ...
  _.fn.extend({
    ...
    closest: function (e, t) {
      ...
      if (!k.test(e)) for (; i < o; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? - 1 < s.index(n)  : 1 === n.nodeType && _.find.matchesSelector(n, e))) {
        r.push(n);
        break
      }
    ...
    _.each({
      ...
      _.fn[e] = function (n, i) {
        ...
        1 < this.length && (I[e] || _.uniqueSort(o), N.test(e) && o.reverse()),
          this.pushStack(o)
      }
    });
  var M = /[^\x20\t\r\n\f]+/g;
  ...
  function W(e, t, n, i) {
    var o;
    try {
      e && g(o = e.promise) ? o.call(e).done(t).fail(n)  : e && g(o = e.then) ? o.call(e, t, n)  : t.apply(void 0, [
        e
      ].slice(i))
    } catch (e) {
      n.apply(void 0, [
      ...
      d = {
        ...
        remove: function () {
          return _.each(arguments, function (e, t) {
            for (var n; - 1 < (n = _.inArray(t, a, n)); ) a.splice(n, 1),
            n <= c && c--
          }),
            this
        },
          ...
          o = {
              ...
              return _.Deferred(function (t) {
                _.each(n, function (n, i) {
                  ...
                  r[i[1]](function () {
                    ...
                    e && g(e.promise) ? e.promise().progress(t.notify).done(t.resolve).fail(t.reject)  : t[i[0] + 'With'](this, o ? [
                      e
                    ] : arguments)
                  })
                }),
            ...
            then: function (t, i, o) {
                    ...
                    c = function () {
                      ...
                      if (!(t < r)) {
                        ...
                        c = e && ('object' == typeof e || 'function' == typeof e) && e.then,
                          g(c) ? o ? c.call(e, s(r, n, j, o), s(r, n, H, o))  : (r++, c.call(e, s(r, n, j, o), s(r, n, H, o), s(r, n, j, n.notifyWith)))  : (i !== j && (a = void 0, l = [
                            e
                          ]), (o || n.resolveWith) (a, l))
                      }
                    },
              ...
              return _.Deferred(function (e) {
                n[0][3].add(s(0, e, g(o) ? o : j, e.notifyWith)),
                  n[1][3].add(s(0, e, g(t) ? t : j)),
  ...
  _.fn.ready = function (e) {
    ...
    _.extend({
      ...
      readyWait: 1,
      ready: function (e) {
        (!0 === e ? --_.readyWait : _.isReady) || (_.isReady = !0) !== e && 0 < --_.readyWait || B.resolveWith(i, [
          _
        ])
      }
    }),
    _.ready.then = B.then,
    'complete' === i.readyState || 'loading' !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(_.ready)  : (i.addEventListener('DOMContentLoaded', F), e.addEventListener('load', F));
  ...
  function _e(e, t, n, i, o) {
    for (var r, s, a, l, c, u, d = t.createDocumentFragment(), h = [
    ], f = 0, p = e.length; f < p; f++) if ((r = e[f]) || 0 === r) if ('object' === b(r)) _.merge(h, r.nodeType ? [
      r
    ] : r);
    else if (we.test(r)) {
      for (s = s || d.appendChild(t.createElement('div')), a = (fe.exec(r) || [
        '',
        ''
      ]) [1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + _.htmlPrefilter(r) + l[2], u = l[0]; u--; ) s = s.lastChild;
      _.merge(h, s.childNodes),
        (s = d.firstChild).textContent = ''
    } else h.push(t.createTextNode(r));
    for (d.textContent = '', f = 0; r = h[f++]; ) if (i && - 1 < _.inArray(r, i)) o && o.push(r);
    else if (c = re(r), s = me(d.appendChild(r), 'script'), c && ve(s), n) for (u = 0; r = s[u++]; ) pe.test(r.type || '') && n.push(r);
    return d
  }
    ...
    n ? (K.set(e, t, !1), _.event.add(e, t, {
      ...
      handler: function (e) {
        ...
        if (1 & e.isTrigger && this[t]) {
          if (s.length) (_.event.special[t] || {
          }).delegateType && e.stopPropagation();
          else if (s = r.call(arguments), K.set(this, t, s), i = n(this, t), this[t](), s !== (o = K.get(this, t)) || i ? K.set(this, t, !1)  : o = {
  ...
  _.event = {
    ...
    add: function (e, t, n, i, o) {
      var r,
        ...
        g,
        m = K.get(e);
      if (m) for (n.handler && (n = (r = n).handler, o = r.selector), o && _.find.matchesSelector(oe, o), n.guid || (n.guid = _.guid++), (l = m.events) || (l = m.events = {
      }), (s = m.handle) || (s = m.handle = function (t) {
        return void 0 !== _ && _.event.triggered !== t.type ? _.event.dispatch.apply(e, arguments)  : void 0
      }), c = (t = (t || '').match(M) || [
        ''
      ]).length; c--; ) f = g = (a = xe.exec(t[c]) || [
      ]) [1],
        p = (a[2] || '').split('.').sort(),
      f && (d = _.event.special[f] || {
      }, f = (o ? d.delegateType : d.bindType) || f, d = _.event.special[f] || {
      }, u = _.extend({
        type: f,
        origType: g,
        data: i,
      ...
      ]).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(f, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, u)  : h.push(u), _.event.global[f] = !0)
    },
    remove: function (e, t, n, i, o) {
      ...
      if (m && (l = m.events)) {
        for (c = (t = (t || '').match(M) || [
          ''
        ]).length; c--; ) if (f = g = (a = xe.exec(t[c]) || [
        ]) [1], p = (a[2] || '').split('.').sort(), f) {
          for (d = _.event.special[f] || {
          }, h = l[f = (i ? d.delegateType : d.bindType) || f] || [
          ], a = a[2] && new RegExp('(^|\\.)' + p.join('\\.(?:.*\\.|)') + '(\\.|$)'), s = r = h.length; r--; ) u = h[r],
          !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ('**' !== i || !u.selector) || (h.splice(r, 1), u.selector && h.delegateCount--, d.remove && d.remove.call(e, u));
    ...
    dispatch: function (e) {
      ...
      if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
        for (s = _.event.handlers.call(this, a, c), t = 0; (o = s[t++]) && !a.isPropagationStopped(); ) for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); ) a.rnamespace && !1 !== r.namespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((_.event.special[r.origType] || {
    ...
    handlers: function (e, t) {
      ...
      if (l && c.nodeType && !('click' === e.type && 1 <= e.button)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ('click' !== e.type || !0 !== c.disabled)) {
        ...
        }, n = 0; n < l; n++) void 0 === s[o = (i = t[n]).selector + ' '] && (s[o] = i.needsContext ? - 1 < _(o, this).index(c)  : _.find(o, this, null, [
          c
        ]).length),
        s[o] && r.push(i);
        r.length && a.push({
    ...
    _.Event = function (e, t) {
      ...
      e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Te : Ee, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget)  : this.type = e,
      t && _.extend(this, t),
      ...
      _.event.special[e] = {
        ...
        handle: function (e) {
          var n,
            i = e.relatedTarget,
            o = e.handleObj;
          return i && (i === this || _.contains(this, i)) || (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t),
            n
        }
      }
    }),
  ...
  function je(e, t) {
    var n,
      ...
      c;
    if (1 === t.nodeType) {
      if (K.hasData(e) && (r = K.access(e), s = K.set(t, r), c = r.events)) for (o in delete s.handle, s.events = {
      }, c) for (n = 0, i = c[o].length; n < i; n++) _.event.add(t, o, c[o][n]);
      G.hasData(e) && (a = G.access(e), l = _.extend({
      }, a), G.set(t, l))
    }
  }
  function He(e, t, n, i) {
    ...
    if (h && (r = (o = _e(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
      for (l = (a = _.map(me(o, 'script'), $e)).length; d < h; d++) c = o,
      d !== f && (c = _.clone(c, !0, !0), l && _.merge(a, me(c, 'script'))),
        n.call(e[d], c, d);
      if (l) for (u = a[a.length - 1].ownerDocument, _.map(a, Me), d = 0; d < l; d++) c = a[d],
  ...
  function We(e, t, n) {
    for (var i, o = t ? _.filter(t, e)  : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || _.cleanData(me(i)),
  ...
  _.extend({
    ...
    clone: function (e, t, n) {
      var i,
        ...
        u = e.cloneNode(!0),
        d = re(e);
      if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || _.isXMLDoc(e))) for (s = me(u), i = 0, o = (r = me(e)).length; i < o; i++) a = r[i],
        'input' === (c = (l = s[i]).nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : 'input' !== c && 'textarea' !== c || (l.defaultValue = a.defaultValue);
      if (t) if (n) for (r = r || me(e), s = s || me(u), i = 0, o = r.length; i < o; i++) je(r[i], s[i]);
      else je(e, u);
      return 0 < (s = me(u, 'script')).length && ve(s, !d && me(e, 'script')),
        u
    },
    cleanData: function (e) {
      for (var t, n, i, o = _.event.special, r = 0; void 0 !== (n = e[r]); r++) if (z(n)) {
        if (t = n[K.expando]) {
    ...
    _.fn.extend({
      ...
      html: function (e) {
        return q(this, function (e) {
          ...
          if ('string' == typeof e && !Pe.test(e) && !ge[(fe.exec(e) || [
            '',
            ''
          ]) [1].toLowerCase()]) {
            e = _.htmlPrefilter(e);
            try {
              ...
              }).nodeType && (_.cleanData(me(t, !1)), t.innerHTML = e);
              t = 0
            } catch (e) {
            }
          }
    ...
    _.each({
      ...
      _.fn[e] = function (e) {
        for (var n, i = [
        ], o = _(e), r = o.length - 1, s = 0; s <= r; s++) n = s === r ? this : this.clone(!0),
          _(o[s]) [t](n),
          a.apply(i, n.get());
  ...
  function qe(e, t, n) {
    var i,
      ...
      s,
      a = e.style;
    return (n = n || Be(e)) && ('' !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = _.style(e, t)), !p.pixelBoxStyles() && Re.test(s) && Fe.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)),
      void 0 !== s ? s + '' : s
  }
  function Ve(e, t) {
    return {
  ...
  function et(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2) 'margin' === n && (l += _.css(e, n + ie[s], !0, o)),
      i ? ('content' === n && (l -= _.css(e, 'padding' + ie[s], !0, o)), 'margin' !== n && (l -= _.css(e, 'border' + ie[s] + 'Width', !0, o)))  : (l += _.css(e, 'padding' + ie[s], !0, o), 'padding' !== n ? l += _.css(e, 'border' + ie[s] + 'Width', !0, o)  : a += _.css(e, 'border' + ie[s] + 'Width', !0, o));
    return !i && 0 <= r && (l += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - r - l - a - 0.5)) || 0),
      l
  }
  function tt(e, t, n) {
    var i = Be(e),
    ...
    return (!p.boxSizingReliable() && o || 'auto' === s || !parseFloat(s) && 'inline' === _.css(e, 'display', !1, i)) && e.getClientRects().length && (o = 'border-box' === _.css(e, 'boxSizing', !1, i), (r = a in e) && (s = e[a])),
  ...
  _.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        null != n && n == n && ('number' !== r || l || (n += o && o[3] || (_.cssNumber[a] ? '' : 'px')), p.clearCloneStyle || '' !== n || 0 !== t.indexOf('background') || (c[t] = 'inherit'), s && 'set' in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n)  : c[t] = n))
      }
    },
      ...
      _.cssHooks[t] = {
        ...
        set: function (e, n, i) {
          var o,
            ...
            l = i ? et(e, t, i, a, r)  : 0;
          return a && s && (l -= Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - et(e, t, 'border', !1, r) - 0.5)),
      ...
      _.cssHooks[e + t] = {
        expand: function (n) {
          for (var i = 0, o = {
            ...
            n
          ]; i < 4; i++) o[e + ie[i] + t] = r[i] || r[i - 2] || r[0];
          return o
        }
      },
  ...
  function ht(e, t, n) {
    for (var i, o = (ft.tweeners[t] || [
    ]).concat(ft.tweeners['*']), r = 0, s = o.length; r < s; r++) if (i = o[r].call(n, t, e)) return i
  }
  function ft(e, t, n) {
    var i,
      o,
    ...
    for (function (e, t) {
      var n,
        ...
        r,
        s;
      for (n in e) if (o = t[i = U(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = _.cssHooks[i]) && 'expand' in s) for (n in r = s.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o);
      else t[i] = o
    }(u, c.opts.specialEasing); r < s; r++) if (i = ft.prefilters[r].call(c, e, u, c.opts)) return g(i.stop) && (_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
      i;
    return _.map(u, ht, c),
  ...
  _.Animation = _.extend(ft, {
    ...
    prefilters: [
      function (e, t, n) {
        ...
        if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(f)) for (i in d && 1 === e.nodeType && (n.overflow = [
          p.overflow,
          p.overflowX,
          p.overflowY
        ], null == (c = m && m.display) && (c = K.get(e, 'display')), 'none' === (u = _.css(e, 'display')) && (c ? u = c : (de([e], !0), c = e.style.display || c, u = _.css(e, 'display'), de([e]))), ('inline' === u || 'inline-block' === u && null != c) && 'none' === _.css(e, 'float') && (l || (h.done(function () {
          p.display = c
    ...
    _.extend({
      prop: function (e, t, n) {
        var i,
          o,
          r = e.nodeType;
        if (3 !== r && 8 !== r && 2 !== r) return 1 === r && _.isXMLDoc(e) || (t = _.propFix[t] || t, o = _.propHooks[t]),
      ...
      toggleClass: function (e, t) {
        ...
        return 'boolean' == typeof t && i ? t ? this.addClass(e)  : this.removeClass(e)  : g(e) ? this.each(function (n) {
          ...
          var t,
            ...
            r,
            s;
          if (i) for (o = 0, r = _(this), s = wt(e); t = s[o++]; ) r.hasClass(t) ? r.removeClass(t)  : r.addClass(t);
  ...
  _.extend(_.event, {
    trigger: function (t, n, o, r) {
      ...
      if (a = p = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !Ct.test(y + _.event.triggered) && ( - 1 < y.indexOf('.') && (y = (b = y.split('.')).shift(), b.sort()), u = y.indexOf(':') < 0 && 'on' + y, (t = t[_.expando] ? t : new _.Event(y, 'object' == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = b.join('.'), t.rnamespace = t.namespace ? new RegExp('(^|\\.)' + b.join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [
        t
      ] : _.makeArray(n, [
        t
      ]), f = _.event.special[y] || {
        ...
        if (!r && !f.noBubble && !m(o)) {
          for (c = f.delegateType || y, Ct.test(c + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a),
            l = a;
        ...
        (h = (K.get(a, 'events') || {
        }) [t.type] && K.get(a, 'handle')) && h.apply(a, n),
        (h = u && a[u]) && h.apply && z(a) && (t.result = h.apply(a, n), !1 === t.result && t.preventDefault());
        return t.type = y,
        r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !z(o) || u && g(o[y]) && !m(o) && ((l = o[u]) && (o[u] = null), _.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, St), o[y](), t.isPropagationStopped() && p.removeEventListener(y, St), _.event.triggered = void 0, l && (o[u] = l)),
          t.result
      }
    },
  ...
  function Ft(e) {
    return function (t, n) {
      ...
      if (g(n)) for (; i = r[o++]; ) '+' === i[0] ? (i = i.slice(1) || '*', (e[i] = e[i] || [
      ]).unshift(n))  : (e[i] = e[i] || [
      ]).push(n)
    }
  }
  ...
  Bt.href = xt.href,
    _.extend({
      ...
      ajax: function (t, n) {
        ...
        var o,
          ...
          x = {
            ...
            getResponseHeader: function (e) {
              ...
              if (u) {
                if (!a) for (a = {
                }; t = $t.exec(s); ) a[t[1].toLowerCase() + ' '] = (a[t[1].toLowerCase() + ' '] || [
                ]).concat(t[2]);
                t = a[e.toLowerCase() + ' ']
              }
        ...
        if (v.promise(x), p.url = ((t || p.url || xt.href) + '').replace(jt, xt.protocol + '//'), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || '*').toLowerCase().match(M) || [
          ''
        ], null == p.crossDomain) {
          c = i.createElement('a');
          try {
        ...
        if (S = 'abort', y.add(p.complete), x.done(p.success), x.fail(p.error), o = qt(Wt, p, n, x)) {
          if (x.readyState = 1, d && m.trigger('ajaxSend', [
            x,
            p
          ]), u) return x;
        ...
        function T(t, n, i, a) {
          ...
          u || (u = !0, l && e.clearTimeout(l), o = void 0, s = a || '', x.readyState = 0 < t ? 4 : 0, c = 200 <= t && t < 300 || 304 === t, i && (w = function (e, t, n) {
          ...
          }(p, w, x, c), c ? (p.ifModified && ((C = x.getResponseHeader('Last-Modified')) && (_.lastModified[r] = C), (C = x.getResponseHeader('etag')) && (_.etag[r] = C)), 204 === t || 'HEAD' === p.type ? S = 'nocontent' : 304 === t ? S = 'notmodified' : (S = w.state, h = w.data, c = !(f = w.error)))  : (f = S, !t && S || (S = 'error', t < 0 && (t = 0))), x.status = t, x.statusText = (n || S) + '', c ? v.resolveWith(g, [
            h,
            S,
            x
          ])  : v.rejectWith(g, [
            ...
            S,
            f
          ]), x.statusCode(b), b = void 0, d && m.trigger(c ? 'ajaxSuccess' : 'ajaxError', [
            x,
            p,
            c ? h : f
          ]), y.fireWith(g, [
  ...
  _.ajaxSetup({
    ...
    _.ajaxPrefilter('json jsonp', function (t, n, i) {
      ...
      if (a || 'jsonp' === t.dataTypes[0]) return o = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback()  : t.jsonpCallback,
        a ? t[a] = t[a].replace(Qt, '$1' + o)  : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
    ...
    p.createHTMLDocument = ((Ut = i.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>', 2 === Ut.childNodes.length),
    _.parseHTML = function (e, t, n) {
      return 'string' != typeof e ? [
      ] : ('boolean' == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((o = (t = i.implementation.createHTMLDocument('')).createElement('base')).href = i.location.href, t.head.appendChild(o))  : t = i), s = !n && [
      ], (r = A.exec(e)) ? [
        t.createElement(r[1])
      ] : (r = _e([e], t, s), s && s.length && _(s).remove(), _.merge([], r.childNodes)));
      var o,
        r,
        s
    },
    ...
    _.proxy = function (e, t) {
      var n,
        i,
        o;
      if ('string' == typeof t && (n = e[t], t = e, e = n), g(e)) return i = r.call(arguments, 2),
        (o = function () {
  ...
  function (e, t) {
    ...
    function r(e) {
      ...
      var s = i && i.nodeName;
      return s && 'BODY' !== s && 'HTML' !== s ? - 1 !== ['TD',
        'TABLE'].indexOf(i.nodeName) && 'static' === t(i, 'position') ? r(i)  : i : e ? e.ownerDocument.documentElement : document.documentElement
    }
    function s(e) {
    ...
    function g(e, n) {
      ...
      return (s && !r ? n.contains(d)  : n === d && 'BODY' !== d.nodeName) && (v = c(v, n)),
        v
    }
    function m(e) {
    ...
    for (var H = Math.min, W = Math.round, R = Math.floor, B = Math.max, F = 'undefined' != typeof window && 'undefined' != typeof document, q = [
      'Edge',
      'Trident',
      'Firefox'
    ], V = 0, X = 0; X < q.length; X += 1) if (F && 0 <= navigator.userAgent.indexOf(q[X])) {
      V = 1;
      break
    }
          ...
          },
          {
            ...
            value: function () {
              return function () {
                ...
                O(this.modifiers, 'applyStyle') && (this.popper.removeAttribute('x-placement'), this.popper.style.position = '', this.popper.style.top = '', this.popper.style.left = '', this.popper.style.right = '', this.popper.style.bottom = '', this.popper.style.willChange = '', this.popper.style[A('transform')] = ''),
            ...
            fn: function (e, t) {
              ...
              var u = t.priority,
                ...
                h = {
                  primary: function (e) {
                    var n = d[e];
                    return d[e] < c[e] && !t.escapeWithReference && (n = B(d[e], c[e])),
                      G({
                      }, e, n)
                  },
          ...
          flip: {
            ...
            fn: function (e, t) {
              ...
              return s.forEach(function (a, l) {
                ...
                }(r)), e.placement = i + (r ? '-' + r : ''), e.offsets.popper = Z({
                }, e.offsets.popper, T(e.instance.popper, e.offsets.reference, e.placement)), e = k(e.instance.modifiers, e, 'flip'))
              }),
                e
            },
            behavior: 'flip',
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var a,
                ...
                v = A('transform');
              if (l = 'bottom' == g ? 'HTML' === u.nodeName ? - u.clientHeight + f.bottom : - d.height + f.bottom : f.top, a = 'right' == m ? 'HTML' === u.nodeName ? - u.clientWidth + f.right : - d.width + f.right : f.left, c && v) h[v] = 'translate3d(' + a + 'px, ' + l + 'px, 0)',
                h[g] = 0,
                h[m] = 0,
  ...
  function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module ? t(exports, require('jquery'), require('popper.js'))  : 'function' == typeof define && define.amd ? define(['exports',
      'jquery',
      'popper.js'], t)  : t((e = e || self).bootstrap = {
    }, e.jQuery, e.Popper)
  }(this, function (e, t, n) {
    'use strict';
    function i(e, t) {
    ...
    var c = {
      ...
      getTransitionDurationFromElement: function (e) {
        ...
        var n = t(e).css('transition-duration'),
          ...
          o = parseFloat(n),
          r = parseFloat(i);
        return o || r ? (n = n.split(',') [0], i = i.split(',') [0], 1000 * (parseFloat(n) + parseFloat(i)))  : 0
      },
      reflow: function (e) {
      ...
      E = function () {
        ...
        return n.toggle = function () {
          ...
          if (i) {
            ...
            if (o) {
              if ('radio' === o.type) if (o.checked && this._element.classList.contains(v)) e = !1;
              else {
    ...
    t(document).on(T.CLICK_DATA_API, w, function (e) {
      e.preventDefault();
      var n = e.target;
      t(n).hasClass(y) || (n = t(n).closest(x)),
    ...
    var k = 'carousel',
      ...
      U = function () {
        ...
        return n.next = function () {
          ...
          n.pause = function (e) {
            e || (this._isPaused = !0),
            this._element.querySelector(X.NEXT_PREV) && (c.triggerTransitionEnd(this._element), this.cycle(!0)),
              ...
              if (t(this._element).hasClass(W)) {
                ...
                t(a).one(c.TRANSITION_END, function () {
                  t(u).removeClass(i + ' ' + o).addClass(H),
                    t(a).removeClass(H + ' ' + o + ' ' + i),
                    s._isSliding = !1,
                    setTimeout(function () {
                      return t(s._element).trigger(f)
                    }, 0)
                }).emulateTransitionEnd(g)
              } else t(a).removeClass(H),
                t(u).addClass(H),
                this._isSliding = !1,
    ...
    t(document).on(M.CLICK_DATA_API, X.DATA_SLIDE, U._dataApiClickHandler),
      t(window).on(M.LOAD_DATA_API, function () {
        for (var e = [
        ].slice.call(document.querySelectorAll(X.DATA_RIDE)), n = 0, i = e.length; n < i; n++) {
          var o = t(e[n]);
          U._jQueryInterface.call(o, o.data())
        }
      }),
      t.fn[k] = U._jQueryInterface,
      t.fn[k].Constructor = U,
      ...
      se = function () {
        function e(e, t) {
          this._isTransitioning = !1,
            ...
            this._config = this._getConfig(t),
            this._triggerArray = [
            ].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
          for (var n = [
          ].slice.call(document.querySelectorAll(re.DATA_TOGGLE)), i = 0, o = n.length; i < o; i++) {
            var r = n[i],
        ...
        return n.toggle = function () {
          ...
          n.show = function () {
            var n,
              i,
              o = this;
            if (!this._isTransitioning && !t(this._element).hasClass(J) && (this._parent && 0 === (n = [
            ].slice.call(this._parent.querySelectorAll(re.ACTIVES)).filter(function (e) {
            ...
            if (!this._isTransitioning && t(this._element).hasClass(J)) {
              ...
              if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                ...
                this._element.style[i] = this._element.getBoundingClientRect() [i] + 'px',
                  ...
                  t(this._element).addClass(te).removeClass(ee).removeClass(J);
                ...
                t(this._element).one(c.TRANSITION_END, function () {
                  e.setTransitioning(!1),
                    t(e._element).removeClass(te).addClass(ee).trigger(Z.HIDDEN)
                }).emulateTransitionEnd(l)
              }
            }
          },
          ...
          n._getParent = function () {
            ...
            var o = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]',
              r = [
              ].slice.call(n.querySelectorAll(o));
        ...
        return i.toggle = function () {
          ...
          i.show = function () {
            if (!(this._element.disabled || t(this._element).hasClass(de) || t(this._menu).hasClass(he))) {
              ...
              t(o).trigger(i),
              i.isDefaultPrevented() || (t(this._menu).toggleClass(he), t(o).toggleClass(he).trigger(t.Event(ue.SHOWN, n)))
            }
          },
          i.hide = function () {
            if (!this._element.disabled && !t(this._element).hasClass(de) && t(this._menu).hasClass(he)) {
              var n = {
                ...
                o = e._getParentFromElement(this._element);
              t(o).trigger(i),
              i.isDefaultPrevented() || (t(this._menu).toggleClass(he), t(o).toggleClass(he).trigger(t.Event(ue.HIDDEN, n)))
            }
          },
          i.dispose = function () {
          ...
          i._getConfig = function (e) {
            return e = s({
            }, this.constructor.Default, t(this._element).data(), e),
          ...
          i._getPlacement = function () {
            var e = t(this._element.parentNode),
              n = Te;
            return e.hasClass(fe) ? (n = Se, t(this._menu).hasClass(me) && (n = xe))  : e.hasClass(pe) ? n = ke : e.hasClass(ge) ? n = Oe : t(this._menu).hasClass(me) && (n = Ee),
              n
          },
          ...
          e._clearMenus = function (n) {
            if (!n || 3 !== n.which && ('keyup' !== n.type || 9 === n.which)) for (var i = [
            ].slice.call(document.querySelectorAll(ye)), o = 0, r = i.length; o < r; o++) {
              ...
              if (n && 'click' === n.type && (l.clickEvent = n), a) {
                ...
                if (t(s).hasClass(he) && !(n && ('click' === n.type && /input|textarea/i.test(n.target.tagName) || 'keyup' === n.type && 9 === n.which) && t.contains(s, n.target))) {
                  ...
                  t(s).trigger(u),
                  u.isDefaultPrevented() || ('ontouchstart' in document.documentElement && t(document.body).children().off('mouseover', null, t.noop), i[o].setAttribute('aria-expanded', 'false'), t(c).removeClass(he), t(s).removeClass(he).trigger(t.Event(ue.HIDDEN, l)))
                }
              }
            }
          },
          ...
          e._dataApiKeydownHandler = function (n) {
            if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(we).length))  : ce.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(de))) {
              ...
              if (o && (!o || 27 !== n.which && 32 !== n.which)) {
                var r = [
                ].slice.call(i.querySelectorAll(Ce));
                if (0 !== r.length) {
    ...
    var Le = t.fn.modal,
      ...
      qe = function () {
        function e(e, t) {
          this._config = this._getConfig(t),
            this._element = e,
            this._dialog = e.querySelector(Fe.DIALOG),
            this._backdrop = null,
            this._isShown = !1,
        ...
        return n.toggle = function (e) {
          ...
          n.show = function (e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
              ...
              this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on($e.CLICK_DISMISS, Fe.DATA_DISMISS, function (e) {
                return n.hide(e)
          ...
          n._showElement = function (e) {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element),
              ...
              t(this._dialog).hasClass(Me) ? this._dialog.querySelector(Fe.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0,
          ...
          n._setScrollbar = function () {
            ...
            if (this._isBodyOverflowing) {
              var n = [
                ].slice.call(document.querySelectorAll(Fe.FIXED_CONTENT)),
                i = [
                ].slice.call(document.querySelectorAll(Fe.STICKY_CONTENT));
          ...
          e._jQueryInterface = function (n, i) {
            return this.each(function () {
              var o = t(this).data('bs.modal'),
                r = s({
                }, Ne, t(this).data(), 'object' == typeof n && n ? n : {
                });
    ...
    t(document).on($e.CLICK_DATA_API, Fe.DATA_TOGGLE, function (e) {
      ...
      var r = t(n).data('bs.modal') ? 'toggle' : s({
    ...
    function ze(e, t, n) {
      ...
      for (var i = (new window.DOMParser).parseFromString(e, 'text/html'), o = Object.keys(t), r = [
      ].slice.call(i.body.querySelectorAll('*')), s = function (e, n) {
        var i = r[e],
          s = i.nodeName.toLowerCase();
        if ( - 1 === o.indexOf(i.nodeName.toLowerCase())) return i.parentNode.removeChild(i),
          'continue';
        var a = [
          ].slice.call(i.attributes),
          l = [
          ].concat(t['*'] || [
          ], t[s] || [
          ]);
      ...
      ft = function () {
        ...
        return i.enable = function () {
          ...
          i.setContent = function () {
            ...
            this.setElementContent(t(e.querySelectorAll(at)), this.getTitle()),
          ...
          i._enter = function (e, n) {
            ...
            e && (n._activeTrigger['focusin' === e.type ? ut : ct] = !0),
              t(n.getTipElement()).hasClass(st) || n._hoverState === nt ? n._hoverState = nt : (clearTimeout(n._timeout), n._hoverState = nt, n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function () {
          ...
          i._leave = function (e, n) {
            ...
            n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = it, n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
      ...
      $t = function () {
        ...
        return n.refresh = function () {
          ...
          this._offsets = [
            ...
            [
              ...
              if (r && (n = document.querySelector(r)), n) {
                ...
                if (s.width || s.height) return [t(n) [i]().top + o,
                  r]
              }
              return null
            }).filter(function (e) {
          ...
          n._activate = function (e) {
            ...
            i.hasClass(Dt) ? (i.closest(Lt.DROPDOWN).find(Lt.DROPDOWN_TOGGLE).addClass(Pt), i.addClass(Pt))  : (i.addClass(Pt), i.parents(Lt.NAV_LIST_GROUP).prev(Lt.NAV_LINKS + ', ' + Lt.LIST_ITEMS).addClass(Pt), i.parents(Lt.NAV_LIST_GROUP).prev(Lt.NAV_ITEMS).children(Lt.NAV_LINKS).addClass(Pt)),
    ...
    t(window).on(At.LOAD_DATA_API, function () {
      for (var e = [
      ].slice.call(document.querySelectorAll(Lt.DATA_SPY)), n = e.length; n--; ) {
        var i = t(e[n]);
        ...
        return n.show = function () {
          ...
          n._transitionComplete = function (e, n, i) {
            ...
            if (t(e).addClass(Wt), 'tab' === e.getAttribute('role') && e.setAttribute('aria-selected', !0), c.reflow(e), e.classList.contains(Bt) && e.classList.add(Ft), e.parentNode && t(e.parentNode).hasClass(Ht)) {
              ...
              if (r) {
                var s = [
                ].slice.call(r.querySelectorAll(zt));
                t(s).addClass(Wt)
              }
    ...
    var Gt = t.fn.toast,
      ...
      an = function () {
        ...
        return n.show = function () {
          ...
          n._getConfig = function (e) {
            return e = s({
            }, rn, t(this._element).data(), 'object' == typeof e && e ? e : {
            }),
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (e, t, n, i, o) {
      ...
      return t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * o - r) * (2 * Math.PI) / s) * - 0.5 + n : a * Math.pow(2, - 10 * (t -= 1)) * Math.sin((t * o - r) * (2 * Math.PI) / s) * 0.5 + i + n
    },
  ...
  jQuery.Velocity ? console.log('Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.')  : (function (e) {
    ...
    if (!e.jQuery) {
      ...
      n.isWindow = function (e) {
        ...
        n.extend = function () {
          ...
          }, l++), 'object' != typeof a && 'function' !== n.type(a) && (a = {
          }), l === c && (a = this, l--); c > l; l++) if (null != (r = arguments[l])) for (o in r) e = a[o],
          a !== (i = r[o]) && (u && i && (n.isPlainObject(i) || (t = n.isArray(i))) ? (t ? (t = !1, s = e && n.isArray(e) ? e : [
          ])  : s = e && n.isPlainObject(e) ? e : {
          }, a[o] = n.extend(u, s, i))  : void 0 !== i && (a[o] = i));
          return a
        },
      ...
      n.expando = 'velocity' + (new Date).getTime(),
        n.uuid = 0;
      for (var o = {
      }, r = o.hasOwnProperty, s = o.toString, a = 'Boolean Number String Function Array Date RegExp Object Error'.split(' '), l = 0; l < a.length; l++) o['[object ' + a[l] + ']'] = a[l].toLowerCase();
    ...
    return function (e, t, n, i) {
      function o(e) {
        return f.isWrapped(e) ? e = [
        ].slice.call(e)  : f.isNode(e) && (e = [
          e
        ]),
          e
      }
      ...
      function a(e, t) {
        ...
        }.apply(null, e)  : f.isArray(e) && 2 === e.length ? y.apply(null, e.concat([t]))  : !(!f.isArray(e) || 4 !== e.length) && s.apply(null, e),
          ...
          for (var o = 0; n > o; o++) if (v.State.calls[o]) {
            ...
            for (var m = Math.min((t - h) / d.duration, 1), y = 0, w = a.length; w > y; y++) {
              ...
              if (r(S)) {
                ...
                for (var T in d.visibility !== i && 'hidden' !== d.visibility && b.setPropertyValue(S, 'visibility', d.visibility), C) if ('element' !== T) {
                  var E,
                    k = C[T],
                  ...
                  if (k.currentValue = E, 'tween' === T) g = E;
                    ...
                    b.Hooks.registered[T] && (r(S).rootPropertyValueCache[D] = b.Normalizations.registered[D] ? b.Normalizations.registered[D]('extract', null, L[1])  : L[1]),
                    'transform' === L[0] && (x = !0)
                  }
                }
                d.mobileHA && r(S).transformCache.translate3d === i && (r(S).transformCache.translate3d = '(0px, 0px, 0px)', x = !0),
            ...
            d.progress && d.progress.call(s[1], s[1], m, Math.max(0, h + d.duration - t), h, g),
            1 === m && c(o)
          }
        }
      ...
      function c(e, t) {
        ...
        for (var n = v.State.calls[e][0], o = v.State.calls[e][1], s = v.State.calls[e][2], a = v.State.calls[e][4], l = !1, c = 0, d = n.length; d > c; c++) {
          ...
          if (t || s.loop || ('none' === s.display && b.setPropertyValue(h, 'display', s.display), 'hidden' === s.visibility && b.setPropertyValue(h, 'visibility', s.visibility)), !0 !== s.loop && (u.queue(h) [1] === i || !/\.velocityQueueEntryFlag/i.test(u.queue(h) [1])) && r(h)) {
            ...
            s.mobileHA && (f = !0, delete r(h).transformCache.translate3d),
          ...
          a && !0 !== s.loop && a(o),
          r(h) && !0 === s.loop && !t && (u.each(r(h).tweensContainer, function (e, t) {
      ...
      if (!(7 >= d)) {
        ...
        var y = function () {
          ...
          return function e(t, i, o) {
            var r,
              ...
              u = 0;
            for (t = parseFloat(t) || 500, i = parseFloat(i) || 20, o = o || null, l.tension = t, l.friction = i, (r = null !== o) ? s = (u = e(t, i)) / o * 0.016 : s = 0.016; a = n(a || l, s), c.push(1 + a.x), u += 16, Math.abs(a.x) > 0.0001 && Math.abs(a.v) > 0.0001; );
            return r ? function (e) {
        ...
        var b = v.CSS = {
            ...
            injectValue: function (e, t, n) {
              ...
              if (i) {
                var o,
                  r = i[0],
                  s = i[1];
                return (o = (n = b.Hooks.cleanRootPropertyValue(r, n)).toString().match(b.RegEx.valueSplit)) [s] = t,
                  o.join(' ')
              }
              return n
            }
                ...
                b.Normalizations.registered[t] = function (e, n, o) {
                  switch (e) {
                    ...
                    case 'inject':
                      ...
                      return s || (r(n).transformCache[t] = '(' + o + ')'),
                  ...
                  switch (e) {
                    ...
                    case 'extract':
                      ...
                      if (b.RegEx.wrappedValueAlreadyExtracted.test(o)) r = o;
                        ...
                        /^[A-z]+$/i.test(o) ? s = a[o] !== i ? a[o] : a.black : b.RegEx.isHex.test(o) ? s = 'rgb(' + b.Values.hexToRgb(o).join(' ') + ')' : /^rgba?\(/i.test(o) || (s = a.black),
                          r = (s || o).toString().match(b.RegEx.valueUnwrap) [1].replace(/,(\s+)?/g, ' ')
                      }
          ...
          Names: {
            ...
            prefixCheck: function (e) {
              ...
              for (var t = [
                ...
                }), f.isString(v.State.prefixElement.style[o])) return v.State.prefixMatches[e] = o,
                  [
                    o,
                    !0
                  ]
          ...
          getPropertyValue: function (e, n, o, s) {
            ...
            if (b.Hooks.registered[n]) {
              ...
              var f,
                p;
              'transform' !== (f = b.Normalizations.registered[n]('name', e)) && (p = a(e, b.Names.prefixCheck(f) [0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[n] && (p = b.Hooks.templates[n][1])),
            ...
            if ((d || v.State.isAndroid && !v.State.isChrome) && r(e).isSVG) {
              ...
              u.each(r(e).transformCache, function (t) {
                return o = r(e).transformCache[t],
                  'transformPerspective' === t ? (s = o, !0)  : (9 === d && 'rotateZ' === t && (t = 'rotate'), void (n += t + o + ' '))
              }),
              s && (n = 'perspective' + s + ' ' + n)
            }
            ...
            return e = o(e),
              u.each(e, function (e, o) {
                if (r(o) === i && v.init(o), n === i) s === i && (s = v.CSS.getPropertyValue(o, t));
                  ...
                  'transform' === a[0] && v.CSS.flushTransformCache(o),
                    s = a
                }
              }),
              s
        ...
        var w = function () {
          ...
          function s() {
            function e(e) {
              function h(e, t) {
                var n = i,
                  o = i,
                  r = i;
                return f.isArray(e) ? (n = e[0], !f.isArray(e[1]) && /^[\d-]/.test(e[1]) || f.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? r = e[1] : (f.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || f.isArray(e[1])) && (o = t ? e[1] : a(e[1], c.duration), e[2] !== i && (r = e[2])))  : n = e,
                t || (o = o || c.easing),
                f.isFunction(n) && (n = n.call(s, x, S)),
                f.isFunction(r) && (r = r.call(s, x, S)),
                  [
                    n || 0,
                    o,
                    r
              ...
              function g() {
                ...
                if (o && i) l.emToPx = I.lastEmToPx,
                  ...
                  v.init(c),
                    ...
                    l.percentToPxWidth = I.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(c, 'width', null, !0)) || 1) / a,
                    l.percentToPxHeight = I.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(c, 'height', null, !0)) || 1) / a,
                    l.emToPx = I.lastEmToPx = (parseFloat(b.getPropertyValue(c, 'paddingLeft')) || 1) / a,
                    e.myParent.removeChild(c)
                }
                return null === I.remToPx && (I.remToPx = parseFloat(b.getPropertyValue(n.body, 'fontSize')) || 16),
                null === I.vwToPx && (I.vwToPx = parseFloat(t.innerWidth) / 100, I.vhToPx = parseFloat(t.innerHeight) / 100),
                  l.remToPx = I.remToPx,
                  l.vwToPx = I.vwToPx,
                  l.vhToPx = I.vhToPx,
              ...
              if ('scroll' === E) {
                ...
                c.container ? f.isWrapped(c.container) || f.isNode(c.container) ? (c.container = c.container[0] || c.container, T = (w = c.container['scroll' + O]) + u(s).position() [O.toLowerCase()] + A)  : c.container = null : (w = v.State.scrollAnchor[v.State['scrollProperty' + O]], C = v.State.scrollAnchor[v.State['scrollProperty' + ('Left' === O ? 'Top' : 'Left')]], T = u(s).offset() [O.toLowerCase()] + A),
                  d = {
                    scroll: {
                      rootPropertyValue: !1,
                      startValue: w,
                ...
                for (var P in D) if ('element' !== P) {
                  ...
                  v.debug && console.log('reverse tweensContainer (' + P + '): ' + JSON.stringify(D[P]), s)
                }
                d = D
              } else if ('start' === E) {
                for (var N in r(s).tweensContainer && !0 === r(s).isAnimating && (D = r(s).tweensContainer), u.each(y, function (e, t) {
                  if (RegExp('^' + b.Lists.colors.join('$|^') + '$').test(e)) {
                    ...
                    if (b.RegEx.isHex.test(o)) {
                      for (var a = [
                        ...
                        'Green',
                        'Blue'
                      ], l = b.Values.hexToRgb(o), c = s ? b.Values.hexToRgb(s)  : i, u = 0; u < a.length; u++) {
                        var d = [
                          l[u]
                        ];
                        r && d.push(r),
                  ...
                  if (r(s).isSVG || 'tween' === R || !1 !== b.Names.prefixCheck(R) [1] || b.Normalizations.registered[R] !== i) {
                    (c.display !== i && null !== c.display && 'none' !== c.display || c.visibility !== i && 'hidden' !== c.visibility) && /opacity|filter/.test(N) && !W && 0 !== j && (W = 0),
                      c._cacheValues && D && D[N] ? (W === i && (W = D[N].endValue + D[N].unitType), B = r(s).rootPropertyValueCache[R])  : b.Hooks.registered[N] ? W === i ? (B = b.getPropertyValue(s, R), W = b.getPropertyValue(s, N, B))  : B = b.Hooks.templates[R][1] : W === i && (W = b.getPropertyValue(s, N));
                    var F,
                      q,
                      V,
                      X = !1;
              ...
              d.element && (b.Values.addClass(s, 'velocity-animating'), $.push(d), '' === c.queue && (r(s).tweensContainer = d, r(s).opts = c), r(s).isAnimating = !0, x === S - 1 ? (v.State.calls.push([$,
                m,
                c,
                null,
                k.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l()))  : x++)
            }
            var o,
              s = this,
              c = u.extend({
            ...
            c.display !== i && null !== c.display && (c.display = c.display.toString().toLowerCase(), 'auto' === c.display && (c.display = v.CSS.Values.getDisplayType(s))),
          ...
          var d,
            ...
            y,
            _,
            C = arguments[0] && (arguments[0].p || u.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties));
          if (f.isWrapped(this) ? (d = !1, p = 0, m = this, h = this)  : (d = !0, p = 1, m = C ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
                ...
                return u.each(v.State.calls, function (e, t) {
                  t && u.each(t[1], function (n, o) {
                    ...
                    return !0 !== s && t[2].queue !== s && (_ !== i || !1 !== t[2].queue) || void u.each(m, function (n, i) {
                      ...
                      ])), 'stop' === y ? (r(i) && r(i).tweensContainer && !1 !== s && u.each(r(i).tweensContainer, function (e, t) {
                ...
                if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                  if (f.isString(y) && v.Redirects[y]) {
                    var A = (N = u.extend({
                      ...
                      D = N.delay || 0;
                    return !0 === N.backwards && (m = u.extend(!0, [
                    ], m).reverse()),
                      u.each(m, function (e, t) {
                        parseFloat(N.stagger) ? N.delay = D + parseFloat(N.stagger) * e : f.isFunction(N.stagger) && (N.delay = D + N.stagger.call(t, e, S)),
                        N.drag && (N.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1000 : g), N.duration = Math.max(N.duration * (N.backwards ? 1 - e / S : (e + 1) / S), 0.75 * N.duration, 200)),
                          v.Redirects[y].call(t, t, N || {
                          }, e, S, m, k.promise ? k : i)
                      }),
                      e()
                  }
                  var P = 'Velocity: First argument (' + y + ') was not a property map, a known action, or a registered redirect. Aborting.';
                  return k.promise ? k.rejecter(new Error(P))  : console.log(P),
                    e()
                }
                E = 'start'
            }
            ...
            }, v.defaults, _)).loop = parseInt(N.loop), L = 2 * N.loop - 1, N.loop) for (var M = 0; L > M; M++) {
              var j = {
                delay: N.delay,
                progress: N.progress
              };
              M === L - 1 && (j.display = N.display, j.visibility = N.visibility, j.complete = N.complete),
                w(m, 'reverse', j)
            }
            return e()
          }
        ...
        return v.State.isMobile || n.hidden === i || n.addEventListener('visibilitychange', function () {
          ...
          e.Velocity = v,
        e !== t && (e.fn.velocity = w, e.fn.velocity.defaults = v.defaults),
          u.each(['Down',
            'Up'], function (e, t) {
          ...
          function r() {
            ...
            n.each(function () {
              ...
              let c = n.data('wow-duration'),
                u = n.data('wow-delay'),
                d = 1000 * n.css('animation-duration').slice(0, - 1);
              'visible' !== n.css('visibility') && (o + r - i > s(this) && r < s(this) || o + r - i > s(this) + n.height() && r < s(this) + n.height() || o + r === e(document).height() && s(this) + i > e(document).height()) && (u && (u = n.data('wow-delay').slice(0, - 1), d += !!n.data('wow-delay') && 1000 * n.data('wow-delay').slice(0, - 1)), c && (c = n.data('wow-duration').slice(0, - 1), d = 1000 * n.css('animation-duration').slice(0, - 1) + 1000 * n.data('wow-duration').slice(0, - 1)), setTimeout(() =>n.removeClass('animated'), d), n.addClass('animated'), n.css({
                visibility: 'visible',
                'animation-name': t[a],
...
s`
          ...
          n.each(function () {
            const n = e(this);
            t[n.index('.wow')] = n.css('animation-name'),
              n.css({
                visibility: 'hidden',
                'animation-name': 'none'
              })
            ...
            n.each(function () {
              ...
              s = !!s && n.data('wow-delay').slice(0, - 1),
                n.addClass('animated'),
                n.css({
                  visibility: 'visible',
                  'animation-name': t[i],
...
s`
  ...
  function (e, t) {
    ...
    return e.init = function (e) {
      ...
      i && (t.addEventListener('touchstart', h, !1), t.addEventListener('touchcancel', d.registerEvent, !1), t.addEventListener('touchend', d.registerEvent, !1)),
      ...
      e.attach = function (e, t) {
        ...
        '[object Array]' === n.call(t) && (t = t.join(' ')),
          t = t ? ' ' + t : '';
        for (var s = 0, a = e.length; s < a; s++) o = (i = e[s]).tagName.toLowerCase(),
        - 1 !== ['input',
      ...
      e.ripple = function (e, t) {
        var n = (e = r(e)).length;
        if ((t = t || {
        }).wait = t.wait || 0, t.position = t.position || null, n) for (var i, o, a, c = {
        }, u = 0, d = {
          type: 'mousedown',
          button: 1
        }, h = function (e, t) {
...
!function (e) {
  ...
  e(i).each(function (t, n) {
    ...
    e(document).on('blur', i, function (t) {
      ...
      i && o && s && n.siblings('label, i').removeClass('active'),
        r(n)
    }),
      ...
      return function () {
        ...
        function u(n) {
          ...
          if (void 0 !== n.optionsOverride && (r = e.extend(r, n.optionsOverride), s = n.optionsOverride.iconClass || s), !function (e, t) {
            ...
            return n.iconClass && u.addClass(r.toastClass).addClass(s),
            n.title && (f.append(n.title).addClass(r.titleClass), u.append(f)),
            n.message && (p.append(n.message).addClass(r.messageClass), u.append(p)),
            r.closeButton && (m.addClass('md-toast-close-button').attr('role', 'button'), u.prepend(m)),
            r.progressBar && (g.addClass('md-toast-progress'), u.prepend(g)),
      ...
      e.fn.dropdown = function (t) {
        this.each(function () {
          ...
          function a(t) {
            ...
            var g = 0,
              m = n.parent();
            if (!m.is('body') && m[0].scrollHeight > m[0].clientHeight && (g = m[0].scrollTop), c + r.innerWidth() > e(window).width() ? d = 'right' : c - r.innerWidth() + n.innerWidth() < 0 && (d = 'left'), u + r.innerHeight() > a) if (u + l - r.innerHeight() < 0) {
              var v = a - u - p;
              r.css('max-height', v)
            } else p || (p += l),
              p -= r.innerHeight();
            if ('left' === d) h = i.gutter,
              f = n.position().left + h;
            else if ('right' === d) {
          ...
          } else n.unbind('click.'.concat(n.attr('id'))),
...
dropdownSelectors.on({
  ...
  function (e) {
    ...
    e('.fixed-action-btn:not(.smooth-scroll) > .btn-floating').on('click', function (o) {
      if (!e(t).hasClass('smooth-scroll')) return o.preventDefault(),
        r = e('.fixed-action-btn'),
        (s = r).hasClass('active') ? i(s)  : n(s),
        !1;
      var r,
        s
    })
          ...
          },
          {
            ...
            value: function (e) {
              if ('touchmove' === e.type) {
                var t = e.touches[0],
                  n = t.clientX;
                Date.now() - this.lastTouchVelocity.x.startTime > 20 && (this.lastTouchVelocity.x.startPosition = t.clientX, this.lastTouchVelocity.x.startTime = Date.now()),
          ...
          },
          {
            ...
            value: function (e) {
              if ('touchend' === e.type) {
                ...
                o > 0 && (o = 0),
                r < 0 && (r = 0),
                  'left' === this.options.edge ? (this.menuOut && n <= 0.3 || n < - 0.5 ? (0 !== o && this.translateMenuX([0,
                    o], '300'), this.showSidenavOverlay())  : (!this.menuOut || n > 0.3) && (this.enableScrolling(), this.translateMenuX([ - 1 * this.options.MENU_WIDTH - 10,
                    o], '200'), this.hideSidenavOverlay()), this.$dragTarget.css({
                    width: '10px',
                    right: '',
                    left: 0
                  }))  : this.menuOut && n >= - 0.3 || n > 0.5 ? (this.translateMenuX([0,
                    r], '300'), this.showSidenavOverlay(), this.$dragTarget.css({
                    width: '50%',
                    right: '',
                    left: 0
                  }))  : (!this.menuOut || n < - 0.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10,
                    r], '200'), this.hideSidenavOverlay(), this.$dragTarget.css({
                    width: '10px',
                    right: 0,
                    left: ''
                  }))
          ...
          },
          {
            ...
            value: function (e) {
              if ('touch' === e.gesture.pointerType) {
                ...
                i > 0 && (i = 0),
                o < 0 && (o = 0),
                  'left' === this.options.edge ? (this.menuOut && t <= 0.3 || t < - 0.5 ? (0 !== i && this.translateMenuX([0,
                    i], '300'), this.showSidenavOverlay())  : (!this.menuOut || t > 0.3) && (this.enableScrolling(), this.translateMenuX([ - 1 * this.options.MENU_WIDTH - 10,
                    i], '200'), this.hideSidenavOverlay()), this.$dragTarget.css({
                    width: '10px',
                    right: '',
                    left: 0
                  }))  : this.menuOut && t >= - 0.3 || t > 0.5 ? (this.translateMenuX([0,
                    o], '300'), this.showSidenavOverlay(), this.$dragTarget.css({
                    width: '50%',
                    right: '',
                    left: 0
                  }))  : (!this.menuOut || t < - 0.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10,
                    o], '200'), this.hideSidenavOverlay(), this.$dragTarget.css({
                    width: '10px',
                    right: 0,
                    left: ''
            ...
            value: function () {
              ...
              this.$element.on('click', function (n) {
                if (n.preventDefault(), !0 === t.menuOut) t.removeMenu();
                  ...
                  t.menuOut = !0,
                    !0 === t.options.showOverlay ? e('#sidenav-overlay').length || (t.$sidenavOverlay = e('<div id="sidenav-overlay"></div>'), t.$body.append(t.$sidenavOverlay))  : t.showCloseButton();
                  var i = [
                  ];
                  i = 'left' === t.options.edge ? [
                    0,
                    - 1 * t.options.MENU_WIDTH
                  ] : [
                    0,
                    t.options.MENU_WIDTH
                  ],
  ...
  function (e) {
    var t,
      n = 'input[type=range]:not(.custom-range):not(.multi-range)',
      ...
      n = function () {
        function t(n, i) {
          _classCallCheck(this, t),
            ...
            this.$materialSelect = e('<input type="text" class="'.concat(this.options.BSinputText ? 'browser-default custom-select multi-bs-select select-dropdown form-control' : 'select-dropdown form-control', '" ').concat(!this.options.validate && 'readonly="true"', ' required="').concat(this.options.validate ? 'true' : 'false', '" ').concat(this.$nativeSelect.is(' :disabled') ? 'disabled' : '', ' data-activates="select-options-').concat(this.uuid, '" value=""/>')),
            this.$dropdownIcon = this.options.BSinputText ? '' : e('<span class="caret">&#9660;</span>'),
            this.$searchInput = null,
            this.$toggleAll = e('<li class="select-toggle-all"><span><input type="checkbox" class="form-check-input"><label>'.concat(this.selectAllLabel, '</label></span></li>')),
            this.$addOptionBtn = e('<i class="select-add-option fas fa-plus"></i>'),
            this.mainLabel = this.$nativeSelect.next('.mdb-main-label'),
            this.$validFeedback = e('<div class="valid-feedback">'.concat(this.options.validFeedback || 'Good choice', '</div>')),
            this.$invalidFeedback = e('<div class="invalid-feedback">'.concat(this.options.invalidFeedback || 'Bad choice', '</div>')),
            this.valuesSelected = [
            ],
            this.keyCodes = {
              tab: 9,
        ...
        return _createClass(t, [
            ...
            value: function (t, n, i) {
              ...
              if (!o.hasClass('disabled') && !o.hasClass('optgroup')) {
                ...
                if (this.isMultiple) {
                  ...
                  r = this.isSearchable && s ? this._toggleSelectedValue(a - o.prevAll('.optgroup').length - 1)  : this.isSearchable ? this._toggleSelectedValue(a - 1)  : s ? this._toggleSelectedValue(a - o.prevAll('.optgroup').length)  : this._toggleSelectedValue(a),
                  this._isToggleAllPresent() && this._updateToggleAllOption(),
                    this.$materialSelect.trigger('focus')
                } else this.$materialOptionsList.find('li').removeClass('active'),
                  o.toggleClass('active'),
          ...
          },
          {
            key: '_onHTMLClick',
            value: function (t) {
              e(t.target).closest('#select-options-'.concat(this.uuid)).length || e(t.target).hasClass('mdb-select') || !e('#select-options-'.concat(this.uuid)).hasClass('active') || (this.$materialSelect.trigger('close'), !this.$materialSelect.val().length > 0 && this.mainLabel.removeClass('active')),
          ...
          },
          {
            ...
            value: function (t) {
              var n = this,
                ...
                o = !e(i).prop('checked');
              e(i).prop('checked', o),
                this.$materialOptionsList.find('li:not(.optgroup):not(.select-toggle-all)').each(function (t, i) {
          ...
          },
          {
            ...
            value: function () {
              ...
              var c = s.is(o) || !r ? s : a;
              this._selectSingleOption(c),
                this._escapeKeyboardActiveOptions(),
              c.find('input').is(':checked') || c.removeClass(this.keyboardActiveClass),
            ...
            value: function (t) {
              ...
              if (this._escapeKeyboardActiveOptions(), this.isSearchable) {
                var i = t.which > 46 && t.which < 91,
                  ...
                  r = 8 === t.which;
                (i || o) && this.$searchInput.find('input').val(t.key).focus(),
          ...
          },
          {
            ...
            value: function (t) {
              var n = e(t.target),
                ...
                s = r && t.shiftKey,
                a = t.which === this.keyCodes.arrowUp;
              if (t.which === this.keyCodes.arrowDown || i || o || a) return this.$materialSelect.focus(),
                void this._handleArrowDownKey();
              var l = n.closest('ul'),
                c = n.val(),
              ...
              if (u.each(function () {
                ...
                if ('string' == typeof this.outerHTML) {
                  ...
                  n.includes(c.toLowerCase()) ? t.show().parent().show()  : t.hide().parent().hide(),
                  n.trim() === c.toLowerCase() && (d = !0)
                }
              ...
              c && this.isEditable && !d ? this.$addOptionBtn.show()  : this.$addOptionBtn.hide(),
  ...
  function (e, t) {
    ...
    w.prototype.eventElement = function (e) {
      ...
      return t || (t = new y(e), this.eventElements.push(t)),
        t
    },
    ...
    var _ = function (e, t, n, i, o) {
        var r;
        if (void 0 === i && (i = !0), void 0 === o && (o = !1), 'top' === t) r = [
          'contentHeight',
          'containerHeight',
          'scrollTop',
          'y',
        ...
        !function (e, t, n, i, o) {
          ...
          var f = e.element;
          e.reach[u] = null,
          f[a] < 1 && (e.reach[u] = 'start'),
          f[a] > e[r] - e[s] - 1 && (e.reach[u] = 'end'),
          t && (f.dispatchEvent(c('ps-scroll-' + u)), t < 0 ? f.dispatchEvent(c('ps-scroll-' + d))  : t > 0 && f.dispatchEvent(c('ps-scroll-' + h)), i && l(e, u)),
      ...
      S = function (e) {
        ...
        t.contains(e.scrollbarYRail) || (r(t, m.element.rail('y')).forEach(function (e) {
          ...
          !e.settings.suppressScrollX && e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth ? (e.scrollbarXActive = !0, e.railXWidth = e.containerWidth - e.railXMarginWidth, e.railXRatio = e.containerWidth / e.railXWidth, e.scrollbarXWidth = h(e, u(e.railXWidth * e.containerWidth / e.contentWidth)), e.scrollbarXLeft = u((e.negativeScrollAdjustment + t.scrollLeft) * (e.railXWidth - e.scrollbarXWidth) / (e.contentWidth - e.containerWidth)))  : e.scrollbarXActive = !1,
          !e.settings.suppressScrollY && e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight ? (e.scrollbarYActive = !0, e.railYHeight = e.containerHeight - e.railYMarginHeight, e.railYRatio = e.containerHeight / e.railYHeight, e.scrollbarYHeight = h(e, u(e.railYHeight * e.containerHeight / e.contentHeight)), e.scrollbarYTop = u(n * (e.railYHeight - e.scrollbarYHeight) / (e.contentHeight - e.containerHeight)))  : e.scrollbarYActive = !1,
        ...
        e.scrollbarYTop >= e.railYHeight - e.scrollbarYHeight && (e.scrollbarYTop = e.railYHeight - e.scrollbarYHeight),
          f(t, e),
          e.scrollbarXActive ? t.classList.add(m.state.active('x'))  : (t.classList.remove(m.state.active('x')), e.scrollbarXWidth = 0, e.scrollbarXLeft = 0, t.scrollLeft = 0),
          e.scrollbarYActive ? t.classList.add(m.state.active('y'))  : (t.classList.remove(m.state.active('y')), e.scrollbarYHeight = 0, e.scrollbarYTop = 0, t.scrollTop = 0)
      },
      x = {
        ...
        wheel: function (t) {
          function n(t, n, i) {
            ...
            for (var r = t; r && r !== o; ) {
              ...
              if ([s.overflow,
                s.overflowX,
                s.overflowY].join('').match(/(scroll|auto)/)) {
        ...
        touch: function (t) {
          ...
          function a(t, n, i) {
            ...
            for (var o = t; o && o !== u; ) {
              ...
              if ([r.overflow,
                r.overflowX,
                r.overflowY].join('').match(/(scroll|auto)/)) {
      ...
      T = function (i, o) {
        var r = this;
        if (void 0 === o && (o = {
        }), 'string' == typeof i && (i = document.querySelector(i)), !i || !i.nodeName) throw new Error('no element is specified to initialize PerfectScrollbar');
        ...
        },
        {
          ...
          value: function () {
            ...
            this.$input.on('keyup', function (n) {
              if (13 === n.which) return t.options.data.includes(t.$input.val()) || t.options.data.push(t.$input.val()),
              ...
              if (t.$autocompleteWrap.empty(), i.length) {
                for (var o in t.options.data) if ( - 1 !== t.options.data[o].toLowerCase().indexOf(i.toLowerCase())) {
  ...
  var e = {
    ...
    n = function (e) {
      if (e.childNodes.length > 0) for (var t = [
      ].slice.call(e.childNodes), n = 0; n < t.length; n++) {
        var i = t[n];
  ...
  function a() {
    for (var t = [
    ].slice.call(this.querySelectorAll(e.INPUT)).filter(function (e) {
  ...
  return {
    init: function (n, i) {
      ...
      void 0 === i && (i = e.FORM);
      for (var o = [
      ].slice.call(document.querySelectorAll(n)), r = [
      ].slice.call(document.querySelectorAll(i)), u = 0, d = o.length; u < d; u++) {
        var h = o[u];
        Object.defineProperty(h, 'bsCustomFileInput', {
          ...
          s.call(h),
          h.addEventListener(c, s)
      }
      for (var f = 0, p = r.length; f < p; f++) r[f].addEventListener(l, a),
    ...
    destroy: function () {
      for (var t = [
      ].slice.call(document.querySelectorAll(e.FORM)).filter(function (e) {
        return !!e.bsCustomFileInput
      }), n = [
      ].slice.call(document.querySelectorAll(e.INPUT)).filter(function (e) {
        return !!e.bsCustomFileInput
      ...
      for (var d = 0, h = t.length; d < h; d++) t[d].removeEventListener(l, a),
  ...
  var e = /\blang(?:uage)?-([\w-]+)\b/i,
    ...
    n = _self.Prism = {
      ...
      highlightElement: function (t, i, o) {
        ...
        a && (r = (a.className.match(e) || [
          ,
          ''
        ]) [1].toLowerCase(), s = n.languages[r]),
          t.className = t.className.replace(e, '').replace(/\s+/g, ' ') + ' language-' + r,
        t.parentNode && (a = t.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(e, '').replace(/\s+/g, ' ') + ' language-' + r));
        var l = {
          element: t,
          language: r,
          grammar: s,
        ...
        if (n.hooks.run('before-sanity-check', l), !l.code || !l.grammar) return l.code && (n.hooks.run('before-highlight', l), l.element.textContent = l.code, n.hooks.run('after-highlight', l)),
        ...
        } else l.highlightedCode = n.highlight(l.code, l.grammar, l.language),
          n.hooks.run('before-insert', l),
          l.element.innerHTML = l.highlightedCode,
        o && o.call(t),
          n.hooks.run('after-highlight', l),
  ...
  if (i.stringify = function (e, t, o) {
    ...
    if (e.alias) {
      var s = 'Array' === n.util.type(e.alias) ? e.alias : [
        e.alias
      ];
  ...
  return o && (n.filename = o.src, n.manual || o.hasAttribute('data-manual') || ('loading' !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(n.highlightAll)  : window.setTimeout(n.highlightAll, 16)  : document.addEventListener('DOMContentLoaded', n.highlightAll))),
    _self.Prism
}();
      ...
      value: function (e, t) {
        if (e.language === t && e.tokenStack) {
          ...
          var n = 0,
            ...
            o = function (r) {
              if (!(n >= i.length)) for (var s = 0; s < r.length; s++) {
                var a = r[s];
                if ('string' == typeof a || a.content && 'string' == typeof a.content) {
                  ...
                  if (d > - 1) {
                    ...
                    if (f || g ? (h = [
                      ...
                      return !!e
                    }), o(h))  : h = p, 'string' == typeof a ? Array.prototype.splice.apply(r, [
                      s,
                      1
                    ].concat(h))  : a.content = h, n >= i.length) break
                  }
      ...
      var e = /\n(?!$)/g,
        t = function (t) {
          ...
          if ('pre-wrap' === i || 'pre-line' === i) {
            ...
            s || ((s = document.createElement('span')).className = 'line-numbers-sizer', o.appendChild(s)),
    ...
    if ('undefined' != typeof self && self.Prism && self.document) {
      ...
      i('label', function (e) {
        ...
        if (t && /pre/i.test(t.nodeName) && t.hasAttribute('data-label')) {
          ...
          return i ? n = i.content : (t.hasAttribute('data-url') ? (n = document.createElement('a')).href = t.getAttribute('data-url')  : n = document.createElement('span'), n.textContent = o),
            n
        }
      }),
              ...
              return o.indexOf('linear') >= 0 ? e[t] = function (e, t, n) {
                ...
                if (n[0].indexOf('at') < 0) {
                  ...
                  if (/\bcenter|top|right|bottom|left\b|^\d+/.test(n[0]) && (i = n.shift().replace(/\s*-?\d+(?:rad|deg)\s*/, '')), /\bcircle|ellipse|closest|farthest|contain|cover\b/.test(n[0])) {
                    ...
                    !s[0] || 'circle' !== s[0] && 'ellipse' !== s[0] || (o = s.shift()),
                    s[0] && (r = s.shift()),
        ...
        s = function (e, t, n, i) {
          ...
          'Array' !== Prism.util.type(n) && (n = [
            ...
            n.forEach(function (e) {
              ...
              s.byLanguages[e].indexOf(o) < 0 && s.byLanguages[e].push(o)
            }),
            s.byType[e] = this
        };
      for (var a in s.prototype.init = function () {
        ...
        if (this._elt || this.init(), this._token) if (this.updater.call(this._elt, this._token.textContent)) {
          ...
          this._elt.className += ' active',
            e.top - this._elt.offsetHeight > 0 ? (this._elt.className = this._elt.className.replace(r, ''), this._elt.style.top = e.top + 'px', this._elt.style.bottom = '')  : (this._elt.className += ' flipped', this._elt.style.bottom = e.bottom + 'px', this._elt.style.top = ''),
            ...
            'Array' !== Prism.util.type(o) && (o = [
              ...
              o.forEach(function (o) {
                var r,
                  ...
                  a,
                  l;
                !0 === o ? (r = 'important', s = e.language, o = e.language)  : (r = o.before || 'important', s = o.inside || o.lang, a = o.root || Prism.languages, l = o.skip, o = e.language),
                !l && Prism.languages[o] && (Prism.languages.insertBefore(s, r, n[t].tokens, a), e.grammar = Prism.languages[o], i[e.language] = {
                  initialized: !0
                })
              })
          }
